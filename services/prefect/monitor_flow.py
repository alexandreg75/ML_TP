...
def decide_action(
    ...
    """
    Si drift_share dépasse threshold => on déclenche un vrai retraining + compare/promotion via MLflow.
    """
    if drift_share >= threshold:
        decision = train_and_compare_flow(as_of=as_of_cur)  # promoted ou skipped
        return (
